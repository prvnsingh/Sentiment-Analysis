...
with open('D:/DataPartition/Work Projects/Work Projects/StockPredictions/Data/DJIA indices data.csv', 'rb') as csvfile:
...
interpolated_df.to_pickle('D:/DataPartition/Work Projects/Work Projects/StockPredictions/Data/pickled_ten_year_filtered_lead_para.pkl')


# Save pandas frame in csv form
interpolated_df.to_csv('D:/DataPartition/Work Projects/Work Projects/StockPredictions/Data/sample_interpolated_df_10_years_filtered_lead_para.csv',
                       sep='\t', encoding='utf-8')



# Reading the data as pickle file
dataframe_read = pd.read_pickle('D:/DataPartition/Work Projects/Work Projects/StockPredictions/Data/pickled_ten_year_filtered_lead_para.pkl')
