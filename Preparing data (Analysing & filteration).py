...
with open('C:/Users/prvns/Downloads/StockPredictions-master/Data/djia_data.csv') as csvfile:
...
interpolated_df.to_pickle('C:/Users/prvns/Downloads/StockPredictions-master/Data/pickled_ten_year_filtered_lead_para.pkl')


# Save pandas frame in csv form
interpolated_df.to_csv('C:/Users/prvns/Downloads/StockPredictions-master/Data/sample_interpolated_df_10_years_filtered_lead_para.csv',
                       sep='\t', encoding='utf-8')


# Reading the data as pickle file
dataframe_read = pd.read_pickle('C:/Users/prvns/Downloads/StockPredictions-master/Data/pickled_ten_year_filtered_lead_para.pkl')
